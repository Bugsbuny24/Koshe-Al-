...
export default async function EditUniversityPage({
  ...
  const university = data as UniversityRow | null;
  if (!university) notFound();

  const action = updateUniversityAction.bind(null, id);
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center gap-3">
        ...
        <SectionHeader eyebrow="Admin" title="Üniversite Düzenle" />
      </div>
      ...
      <div className="glass-card p-6">
        <form action={action} className="space-y-5">
          ...
          <div>
            ...
            <select
              name="active"
              defaultValue={university.active ? "true" : "false"}
