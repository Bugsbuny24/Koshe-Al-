...
import { Deal, DealMilestone } from '@/types/deals';
...
export default function DealMilestonesPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (d.deal) { setDeal(d.deal); setMilestones(d.milestones || []); }
    setLoading(false);
  }, [id]);
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <DealTabs dealId={id} />
      <MilestonesPanel dealId={id} milestones={milestones} onUpdate={load} />
    </div>
  );
}
