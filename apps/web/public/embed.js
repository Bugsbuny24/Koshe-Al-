 ...
 * Usage:
 *   <div data-adgenius-slot="your-slot-key"></div>
...
;(function () {
  ...
  function renderAd(container, ad) {
    ...
    var impUrl = API_BASE + ad.impression_url
  ...
  function loadSlot(container) {
    ...
    fetch(API_BASE + '/api/v1/serve/ad?' + params.toString(), {
      method: 'GET',
      credentials: 'omit',
    })
      .then(function (res) {
        if (!res.ok) throw new Error('No ad available')
        return res.json()
      })
      .then(function (ad) {
